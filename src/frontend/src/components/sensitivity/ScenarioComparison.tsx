...
export default function ScenarioComparison() {
  ...
  const [editingScenario, setEditingScenario] = useState<
    "base" | "optimistic" | "pessimistic" | null
  >(null);
      ...
      <div className="space-y-4">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {formatCurrency(scenarios.base.npv)}
                </TableCell>
              ...
              <TableRow>
                ...
                <TableCell className="text-right">
                  {formatPercentage(scenarios.base.irr)}
                </TableCell>
                <TableCell className="text-right text-green-600 dark:text-green-400">
              ...
              <TableRow>
                ...
                <TableCell className="text-right">
                  {formatPercentage(scenarios.base.roi)}
                </TableCell>
                <TableCell className="text-right text-green-600 dark:text-green-400">
              ...
              <TableRow>
                ...
                <TableCell className="text-right">
                  {formatNumber(scenarios.base.lom, 1)} years
                </TableCell>
                <TableCell className="text-right">
                  {formatNumber(scenarios.optimistic.lom, 1)} years
                </TableCell>
                <TableCell className="text-right">
                  {formatNumber(scenarios.pessimistic.lom, 1)} years
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
        ...
        <div className="flex gap-2 justify-end">
          <Button
            variant="outline"
            size="sm"
            onClick={() => setEditingScenario("base")}
          >
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => setEditingScenario("optimistic")}
          >
            <Edit className="w-4 h-4 mr-2" />
            Edit Optimistic
          </Button>
          <Button
            variant="outline"
            size="sm"
            onClick={() => setEditingScenario("pessimistic")}
          >
            <Edit className="w-4 h-4 mr-2" />
            Edit Pessimistic
          </Button>
