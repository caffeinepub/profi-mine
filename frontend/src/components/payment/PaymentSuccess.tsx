        ...
        <CardHeader className="text-center">
          {isPending && (
            <>
              ...
              <CardTitle className="text-2xl">Finalizing your upgrade…</CardTitle>
              <CardDescription>
          ...
          {isError && (
            <>
              ...
              <CardTitle className="text-2xl">Upgrade Activation Failed</CardTitle>
              <CardDescription>
                Your payment was received, but we couldn't activate your Premium subscription automatically.
              </CardDescription>
            </>
          )}
        </CardHeader>
            ...
            <>
              <div className="bg-muted/50 rounded-lg p-4 border border-border">
                <p className="text-sm text-muted-foreground mb-2">
                  Thank you for upgrading to Premium. Your new features are now active:
                </p>
          ...
          {isError && (
            <>
              <div className="bg-destructive/5 rounded-lg p-4 border border-destructive/20">
                <p className="text-sm text-muted-foreground mb-2">
                  Your payment was processed successfully by Stripe. To activate your Premium account, please try again or contact support.
                </p>
                <p className="text-xs text-muted-foreground">
                  Error: {markAsPremium.error instanceof Error ? markAsPremium.error.message : 'Unknown error'}
                </p>
              </div>
              <Button
                onClick={handleRetry}
