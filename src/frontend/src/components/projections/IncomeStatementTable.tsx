  ...
  return (
    <ScrollArea className="w-full">
      <Table>
        ...
        <TableBody>
          <TableRow>
            <TableCell className="sticky left-0 bg-background font-medium">Revenue</TableCell>
          ...
          <TableRow>
            <TableCell className="sticky left-0 bg-background font-medium">OPEX</TableCell>
            <TableCell className="text-right">-</TableCell>
            {calculations.yearlyData.map((data, i) => (
          ...
          <TableRow>
            <TableCell className="sticky left-0 bg-background font-medium">Royalties</TableCell>
            <TableCell className="text-right">-</TableCell>
            {calculations.yearlyData.map((data, i) => (
          ...
          <TableRow className="bg-muted/50">
            <TableCell className="sticky left-0 bg-muted/50 font-semibold">EBITDA</TableCell>
            <TableCell className="text-right">-</TableCell>
            {calculations.yearlyData.map((data, i) => (
          ...
          <TableRow>
            <TableCell className="sticky left-0 bg-background font-medium">Taxes</TableCell>
            <TableCell className="text-right">-</TableCell>
            {calculations.yearlyData.map((data, i) => (
          ...
          <TableRow className="bg-muted/50 font-bold">
            <TableCell className="sticky left-0 bg-muted/50">Net Income</TableCell>
            <TableCell className="text-right">-</TableCell>
            {calculations.yearlyData.map((data, i) => (
