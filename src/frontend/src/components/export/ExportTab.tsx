...
export default function ExportTab() {
  ...
  const handleExcelExport = async () => {
    try {
      ...
      const errorMessage =
        error instanceof Error ? error.message : "Failed to export CSV file";
  ...
  return (
    <div className="space-y-6">
      <Alert>
        ...
        <AlertDescription>
          Export your financial data and charts. Use CSV for detailed data
          analysis in Excel, Google Sheets, or any spreadsheet application.
        </AlertDescription>
      </Alert>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="border border-border rounded-lg p-6 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Includes summary, assumptions, production, income statement, and
              cash flow data. Can be opened in Excel, Google Sheets, or any
          ...
          <div className="border border-border rounded-lg p-6 space-y-3">
            ...
            <p className="text-sm text-muted-foreground">
              Each chart in the Projections tab has an export button in the
              top-right corner. Click it to download the chart as a PNG image
              file.
            </p>
          </div>
        </CardContent>
